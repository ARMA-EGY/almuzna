            ...
            <div class="col-lg-6 col-7 text-right">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">{{ isset($customer) ? 'تعديل بيانات عميل' : 'اضافة عميل جديد' }}</li>
                </ol>
              </nav>
            </div>
      ...
      <div class="row">
        <div class="col-xl-12">
            <div class="card card-defualt">
                <div class="card-header">{{ isset($customer) ? 'تعديل بيانات عميل' : 'اضافة عميل جديد' }} </div>
                    ...
                    <form action="{{ isset($customer) ? route('customers.update', $customer->id) : route('customers.store')  }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 mb-2 text-right">
                                ...
                                <input type="text" name="name" class="@error('name') is-invalid @enderror form-control" placeholder="اسم العميل" value="{{ isset($customer) ? $customer->name : old('name') }}" >
                            ...
                            <!--=================  Phone  =================-->
                            <div class="form-group col-md-6 mb-2 text-right">
                                <label class="font-weight-bold text-uppercase">الهاتف</label>
                                <input type="text" name="phone" class="@error('phone') is-invalid @enderror form-control" placeholder="رقم الهاتف" value="{{ isset($customer) ? $customer->phone : old('phone') }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 mb-2 text-right">
                                ...
                                <input type="text" name="email" class="@error('email') is-invalid @enderror form-control" placeholder="البريد الالكتروني" value="{{ isset($customer) ? $customer->email : old('email') }}" >
